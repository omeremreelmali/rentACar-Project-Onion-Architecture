...
using IEntityTimestamps = Domain.Entities.IEntityTimestamps;
    ...
    where TContext : DbContext
{
    ...
    public Task<Paginate<TEntity>> GetListByDynamicAsync(DynamicQuery dynamic, Expression? predicate = null, Func<IQueryable<TEntity>, IIncludableQueryable<TEntity, object>>? include = null, int index = 0,
    ...
    Task<Paginate<TEntity>> IAsyncRepository<TEntity, TEntityId>.GetListAsync(Expression<Func<TEntity, bool>>? predicate, Func<IQueryable<TEntity>, IOrderedQueryable<TEntity>>? orderBy, Func<IQueryable<TEntity>, IIncludableQueryable<TEntity, object>>? include, int index,
        int size, bool withDeleted, bool enableTracking, CancellationToken cancellationToken)
    {
        return GetListAsync(predicate, orderBy, include, index, size, withDeleted, enableTracking, cancellationToken);
    }
    ...
    Paginate<TEntity> IRepository<TEntity, TEntityId>.GetList(Expression<Func<TEntity, bool>>? predicate, Func<IQueryable<TEntity>, IOrderedQueryable<TEntity>>? orderBy, Func<IQueryable<TEntity>, IIncludableQueryable<TEntity, object>>? include, int index, int size,
        bool withDeleted, bool enableTracking)
    {
        return GetList(predicate, orderBy, include, index, size, withDeleted, enableTracking);
    }

    Paginate<TEntity> IRepository<TEntity, TEntityId>.GetListByDynamic(DynamicQuery dynamic, Expression<Func<TEntity, bool>>? predicate, Func<IQueryable<TEntity>, IIncludableQueryable<TEntity, object>>? include, int index,
        int size, bool withDeleted, bool enableTracking)
    {
        return GetListByDynamic(dynamic, predicate, include, index, size, withDeleted, enableTracking);
    }
